...
class CustomBert(nn.Module):
    ...
    def __init__(self, model_name_or_path="bert-base-uncased", n_classes=7): ## nous avons 7 classe ou catégorie de classe 
        """
...
def main():
    ...
    train_dataset = IMDBDataset(csv_file="train_IBDM.cvs", device=device, max_length=512)
    test_dataset = IMDBDataset(csv_file="test_IBDM.cvs", device=device, max_length=512)
